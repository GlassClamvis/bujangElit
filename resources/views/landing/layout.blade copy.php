                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul class="navbar-nav m-auto">
                                        ...
                                        <li class="nav-item {{ $data['menu'] == 'l1' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('/') }}">Berita dan Informasi</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l1' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('/') }}">Penelitian dan
                                                Pengembangan</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l1' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('/') }}">Inovasi Daerah</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l1' ? 'active' : '' }}">
                                        ...
                                        <li class="nav-item {{ $data['menu'] == 'l3' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('jurnal-all') }}">Jurnal</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l4' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('book-all') }}">Buku</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l5' ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ url('bookmark') }} ">Bookmark</a>
                                        </li>
                                        <li class="nav-item {{ $data['menu'] == 'l6' ? 'active' : '' }}">
