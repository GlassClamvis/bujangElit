...
<div class="row animate__animated animate__backInLeft">
    <form action="{{ route('penerbit.update',$idEncrypt)}}" id="frmStaff" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="col-lg-12" data-aos="fade-up" data-aos-duration="3000">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="header-title mb-0 flex-grow-1">Halaman Untuk Mengubah Data Penerbit</h4>
            ...
            <div class="card-body">
                <div class="live-preview">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-8 row mt-3 mb-3">
                            ...
                            <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" value="{{old('nama')?old('nama'):$penerbit->label}}" id="nama" name="nama" placeholder="Masukan Nama Penerbit" required="">
                                    @error('nama')
                            ...
                            <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" value="{{old('no_hp')?old('no_hp'):$penerbit->nomor_telepon}}" id="no_hp" name="no_hp" placeholder="Masukan Nomor Handphone" onkeypress="return hanyaAngka(event)">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" value="{{old('email')?old('email'):$penerbit->email}}" id="email" name="email" placeholder="Masukan E-Mail" >
                                    @error('email')
                            ...
                            <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" value="{{old('alamat')?old('alamat'):$penerbit->alamat}}" id="alamat" name="alamat" placeholder="Masukan Kota Penerbit">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 d-flex justify-content-center">
                                <div class="col-6">
                                    <div class="col-12 btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" name="is_aktif" id="is_aktif1" value="1" autocomplete="off" @if($penerbit->is_aktif == 1) checked @endif>
                                        <label class="btn btn-outline-primary" for="is_aktif1">&nbsp;&nbsp;&nbsp;&nbsp;Aktif&nbsp;&nbsp;&nbsp;</label>

                                        <input type="radio" class="btn-check" name="is_aktif" id="is_aktif2" value="0" autocomplete="off" @if($penerbit->is_aktif == 0) checked @endif>
