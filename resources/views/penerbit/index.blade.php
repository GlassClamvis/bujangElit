    ...
    <div class="col-xl-12">
        <div class="card tableElement">
            <div class="card-header align-items-center d-flex" style="margin-bottom:0px;padding-bottom:0px;">
                <h4 class="header-title mb-0 flex-grow-1">Tabel Data Penerbit</h4>
                 @can('penerbit-create')
                <div class="col col-md-auto d-flex align-items-start justify-content-end">
                    <a href="{{ route('penerbit.create') }}" class="btn btn-blue waves-effect waves-light" id="BtnAddPegawai">
...
<script type="text/javascript">
   var getPenerbit = "{{route('getPenerbit')}}";
   var penerbitDelete = "{{url('penerbitDelete')}}";
   var csrf = "{{ csrf_token() }}";
   initIndex();
</script>
@endsection
