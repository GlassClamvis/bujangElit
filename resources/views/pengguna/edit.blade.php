...
@section('content')
    ...
    <div class="row animate__animated animate__backInLeft">
        <form action="{{ route('pengguna.update', $idEncrypt) }}" id="frmStaff" method="post"
            ...
            <div class="col-lg-12" data-aos="fade-up" data-aos-duration="3000">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="header-title mb-0 flex-grow-1">Halaman Untuk Mengubah Data Pengguna</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-8 row mt-3 mb-3">
                                    ...
                                    <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text"
                                                value="{{ old('nama') ? old('nama') : $pengguna->nama }}" id="nama"
                                    ...
                                    <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text"
                                                value="{{ old('no_hp') ? old('no_hp') : $pengguna->no_hp }}" id="no_hp"
                                                name="no_hp" placeholder="Masukan Nomor Handphone"
                                                onkeypress="return hanyaAngka(event)">
                                        </div>
                                    </div>
                                    @if (Auth::user()->can('user-change-unit'))
                                    <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <option></option>
                                            @foreach ($unit as $v)
                                                <option value="{{ $v->id }}" {{$v->id == $units->unit_id ? 'selected':''}} > {{ $v->title }}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                    </div>
                                    @else
                                    <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                        <label for="no_hp" class="col-sm-3 form-label float-end">Unit</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text"
                                                value="{{@$units->UnitData->title }}"
                                                name="unit" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6 mb-3">
                                        <div>
                                            <label for="email" class="form-label"><span style="color: red">*</span>E -
                                                Mail </label>
                                            <input class="form-control" type="text"
                                                value="{{ old('email') ? old('email') : $pengguna->email }}" id="email"
