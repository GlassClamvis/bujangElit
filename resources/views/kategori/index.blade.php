    ...
    @endif
        ...
        <div class="col-xl-12">
            ...
            <div class="card formElementAdd" style="display: none;" id="formContainerAdd">
                <div class="card-body ">
                    ...
                    <p class="text-muted font-13 mb-4">
                        Halaman Untuk Menambah <code>Data Kategori</code>.
                    </p>

                       <form action="<?php echo @$link;?>" class="form-horizontal" id="frmKategori" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="copy-fields">
                                    <div class="row form-group col-md-12 abc vstack gap-3" style="margin-bottom: 10px;">
                                        <div class="col-md-12 row">
                                            <div class="col-md-10">
                                                <input class="form-control txtKategori" type="text" name="kategori[]" placeholder="Masukan Kategori" required="">
                                            </div>
            ...
            <div class="card formElementEdit" style="display: none;" id="formContainer">
                <div class="card-body ">
                    <h4 class="header-title">Ubah Data Kategori</h4>
                    <p class="text-muted font-13 mb-4">
                        Halaman Untuk Merubah <code>Data Kategori</code>.
                    </p>
                    <form action="" class="form-horizontal" id="frmKategoriUbah" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row d-flex justify-content-center">
                            <div class="row form-group col-md-12 abc vstack gap-3" style="margin-bottom: 10px;">
                                <div class="col-md-12 ">
                                    <div class="hstack gap-3">
                                        <input class="form-control" type="text" id="kategoriUbah" name="kategori" placeholder="Masukan Kategori" required="">
                            ...
                            <div class="col-md-12 row button-items justify-content-center gap-3">
                                <button type="submit" id="btnSubmit" class="col-md-4 btn btn-primary waves-effect waves-light ">Simpan Data Kategori</button>
            ...
            <div class="card tableElement wow fadeInLeft" id="tableCard" style="display: @if ($errors->any()) none @else block @endif" >
                    <div class="card-header align-items-center d-flex">
                        <h4 class="header-title mb-0 flex-grow-1">Tabel Kategori</h4>

                    @can('kategori-create')
                          <div class="col col-md-auto d-flex align-items-start justify-content-end">
                            <button type="button" class="btn btn-blue waves-effect waves-light" id="BtnAddKategori">
                                <i class="mdi mdi-label-variant-outline me-1" style="font-size: 16px;"></i>
                ...
                <div class="card-body ">
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table id="tableKategori" class="table dt-responsive nowrap w-100"  data-datatable="#datatablePagination">
...
var getKategori = "{{route('getKategori')}}";
var act = "{{route('kategori.store')}}";
var kategoriDelete = "{{url('kategoriDelete')}}";
var csrf = "{{ csrf_token() }}";
initIndex();
initEdit();
</script>
