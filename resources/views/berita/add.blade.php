...
@section('content')
    ...
    <div class="row animate__animated animate__backInLeft">
        <form action="{{ route('berita.store') }}" id="frmBerita" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="header-title mb-0 flex-grow-1">Halaman Untuk Menambah Data Berita</h4>
                    ...
                    <div class="card-body live-preview row g-3">
                        ...
                        <div class="col-lg-8 row mt-3">
                            <div class="col-12 col-sm-12 col-xs-12">
                                ...
                                <textarea class="form-control" type="text" value="{{ old('judul') }}" id="judul" name="judul"
                                    placeholder="Masukan Judul Berita" required=""></textarea>
                                @error('judul')
                            ...
                            <div class="col-6">
                                <label class="form-label" style="margin:0px 0px 8px 0px !important;">Status
                                    Berita</label>
                                <div class="col-12 btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="is_aktif" id="is_aktif2" value="1"
                                        autocomplete="off">
                                    <label class="btn btn-outline-warning" for="is_aktif2">Draft</label>

                                    <input type="radio" class="btn-check" name="is_aktif" id="is_aktif1" value="2"
                                        autocomplete="off" checked="">
                                    <label class="btn btn-outline-success" for="is_aktif1">Publish</label>

                                    <input type="radio" class="btn-check" name="is_aktif" id="is_aktif3" value="3"
                                        autocomplete="off">
                            ...
                            <div class="col-3">
                                ...
                                <input type="number" pattern="\d*" data-toggle="touchspin" class="form-control"
                                    name="read_time" value="0" id="readtime" />
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-xs-12 mb-3 row">
                                ...
                                {{--   <div class="col-6">
                                    <label for="tag" class="form-label">Tag Berita</label>
                        ...
                        <div class="col-12 col-sm-12 col-xs-12 mb-3">
                            ...
                            <textarea class="form-control" id="berita" name="berita" rows="7"></textarea>
                        </div>
