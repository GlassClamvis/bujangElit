...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card tableElement">
                <div class="card-header align-items-center d-flex" style="margin-bottom:0px;padding-bottom:0px;">
                    <h4 class="header-title mb-0 flex-grow-1">Tabel Data Berita</h4>
                    @can('berita-create')
                        <div class="col col-md-auto d-flex align-items-start justify-content-end">
                            <a href="{{ route('berita.create') }}" class="btn btn-blue waves-effect waves-light"
                                id="BtnAddPegawai">
                                <i class="mdi mdi-newspaper me-1" style="font-size: 16px;"></i>
                                Tambah Data Berita
                            </a>
                        </div>
                    @endcan
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table id="tableBerita" class="table dt-responsive nowrap w-100">
    ...
    <script type="text/javascript">
        var getBerita = "{{ route('getBerita') }}";
        var beritaDelete = "{{ url('beritaDelete') }}";
        var csrf = "{{ csrf_token() }}";
        initIndex();
    </script>
@endsection
