...
function __construct()
{
    ...
    public function create()
    {
        ...
        return view('jurnal.add', compact('data', 'Breadcrumb', 'kategori', 'tag'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('jurnal.edit', compact('jurnal', 'fileBuku', 'fileCover', 'data', 'Breadcrumb', 'idEncrypt', 'kategori', 'tag', 'arrTag', 'pengarang'));
    }
